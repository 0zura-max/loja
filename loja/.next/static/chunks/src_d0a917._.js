(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_d0a917._.js", {
        ...
        "ProdutoForm.useEffect": ()=>{
            if (isEditing) {
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/produtos/${produtoId}`).then({
                    ...
                    "ProdutoForm.useEffect": (error)=>console.error("Erro ao buscar produto:", error)
                }["ProdutoForm.useEffect"]);
            }
        }
    }["ProdutoForm.useEffect"], [
...
_s(ProdutoForm, "QeFLrMnVftNlYcW175D3+GbSwDU=", false, function() {
    return [
...
//# sourceMappingURL=src_d0a917._.js.map