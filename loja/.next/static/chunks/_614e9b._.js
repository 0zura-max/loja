(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_614e9b._.js", {
...
function ClienteForm({ clienteId }) {
    ...
    useEffect({
        "ClienteForm.useEffect": ()=>{
            if (isEditing) {
                api.get(`/clientes/${clienteId}`).then({
                    "ClienteForm.useEffect": (response)=>setCliente(response.data)
                }["ClienteForm.useEffect"]).catch({
                    "ClienteForm.useEffect": (error)=>console.error("Erro ao buscar cliente:", error)
                }["ClienteForm.useEffect"]);
            }
        }
    }["ClienteForm.useEffect"], [
...
_s(ClienteForm, "RVUyUgCynodmJlQQ3ofgRp8OMr0=", true);
_c = ClienteForm;
var _c;
...
_s(EditarCliente, "H99Cz0PSiisOOdXqr831gRSgvVo=", false, function() {
    return [
...
_c = EditarCliente;
var _c;
__turbopack_refresh__.register(_c, "EditarCliente");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_614e9b._.js.map